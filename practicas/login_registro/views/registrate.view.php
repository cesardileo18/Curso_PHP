...
<body>
	<div class="contenedor">
		...
		<form class="formulario" name="login" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
			...
			<div class="form-group">
				<i class="icono izquierda fas fa-envelope"></i><input class="usuario" type="email" name="correo" placeholder="Correo">
			</div>

			<div class="form-group">
				<i class="icono izquierda fas fa-envelope"></i><input class="usuario" type="email" name="correo2" placeholder="Repite el correo">
			</div>
